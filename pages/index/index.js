...
Page({
  data: {
    ...
    index: 0,
    show_no:0,//是否显示计算框
    kdgs: [{ id: "3", name: "女装" }, { id: "4", name: "女衬衫" }, { id: "5", name: "连衣裙" }, { id: "6", name: "女裤子" }, { id: "7", name: "男装" }, { id: "8", name: "男衬衫" }, { id: "9", name: "男西装" }, { id: "10", name: "男裤子" }, { id: "11", name: "童装" }, { id: "12", name: "婴童装(0-1.5岁)" }, { id: "13", name: "中童装(1.5-10岁)" }, { id: "14", name: "大童装(10-15岁)" }, { id: "15", name: "文胸" },  { id: "16", name: "内裤" }, { id: "17", name: "鞋码" }],
    ci:"",
    tishi1:"您的身高，单位：厘米",
    tishi2:"您的体重，单位：斤"
  },
  ...
  get_shengao: function(e) {
    //console.log(e);
    this.setData({ my_shengao: e.detail.value });
  },
  //输入框事件
  get_tizhong: function (e) {
    //console.log(e);
    this.setData({ my_tizhong: e.detail.value });
  },
  ...
  btnClick: function(){
    ...
    this.calSize(this.data.my_shengao, this.data.my_tizhong, this.data.kdgs[this.data.index].id, function(data){
      //console.log(data);      
  thispage.setData({chimaInfo: data});
    });
  },
...
set_conbiao:function(ci){
  ...
  this.setData({
    ci: ci, cm_title: cm_title, cm_shuoming: cm_shuoming, tishi1: this.data.tishi1, tishi2: this.data.tishi2, show_no: this.data.show_no
  })
},
...
else if(ci==15) { sarr = ["32/70A", 68, 72, 80, 82, "32/70B", 68, 72, 83, 84, "32/70C", 68, 72, 85, 87, "32/70D", 68, 72, 88, 88, "34/75A", 73, 77, 85, 87, "34/75B", 73, 77, 88, 89, "34/75C", 73, 77, 90, 94, "34/75D", 73, 77, 95, 97, "34/75E", 73, 77, 98, 98, "36/80A", 78, 82, 90, 92, "36/80B", 78, 82, 93, 94, "36/80C", 78, 82, 95, 97, "36/80D", 78, 82, 98, 102, "36/80E", 78, 82, 103, 103, "38/85A", 83, 87, 95, 97, "38/85B", 83, 87, 99, 101, "38/85C", 83, 87, 101, 103, "38/85D", 83, 87, 103, 105, "40/90B", 88, 92, 103, 104, "40/90C", 88, 92, 105, 107, "40/90D", 88, 92, 108, 112, "40/90E", 88, 92, 113, 113]; }
for(var i= 0;i<sarr.length/5;i++){
  if (wight >= sarr[5 * i + 1] && wight <= sarr[5 * i + 2] && height >= sarr[5 * i + 3] && height <= sarr[5 * i + 4]) { size = sarr[5 * i]; break; }
  if (i == sarr.length / 5 - 1) { cb("亲！你的身材实在是太棒了，已经超出了普通人的范畴！");return; }
}
if (ci == 6) { switch (size) { case "XS": size = "24/25"; break; case "S": size = "25/26"; break; case "M": size = "27/28"; break; case "L": size = "29/30"; break; case "XL": size = "31/32"; break; case "XXL": size = "33/34"; break; } }
if (ci == 7) { switch (size) { case 44: size = "XS"; break; case 46: size = "S"; break; case 48: size = "M"; break; case 50: size = "L"; break; case 52: size = "XL"; break; case 54: size = "XXL"; break; case 56: size = "XXXL"; break; } }
if (ci == 8) { switch (size) { case 44: size = "37"; break; case 46: size = "38"; break; case 48: size = "39"; break; case 50: size = "40"; break; case 52: size = "41"; break; case 54: size = "42"; break; case 56: size = "43"; break; } }
if (ci == 10) { switch (size) { case 44: size = "27"; break; case 46: size = "28/29/30"; break; case 48: size = "30/31/32"; break; case 50: size = "33/34"; break; case 52: size = "35/36"; break; case 54: size = "38"; break; case 56: size = "40"; break; } }
cb("您适合的尺码为：" + size); return;},
